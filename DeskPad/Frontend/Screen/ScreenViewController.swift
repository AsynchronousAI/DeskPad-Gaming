...
class ScreenViewController: SubscriberViewController<ScreenViewData>, NSWindowDelegate {
    ...
    override func viewDidLoad() {
        ...
        settings.modes = [
            // 16:9
            CGVirtualDisplayMode(width: 3840, height: 2160, refreshRate: 50000),
            CGVirtualDisplayMode(width: 2560, height: 1440, refreshRate: 50000),
            CGVirtualDisplayMode(width: 1920, height: 1080, refreshRate: 50000),
            CGVirtualDisplayMode(width: 1600, height: 900, refreshRate: 50000),
            CGVirtualDisplayMode(width: 1366, height: 768, refreshRate: 50000),
            CGVirtualDisplayMode(width: 1280, height: 720, refreshRate: 50000),
            // 16:10
            CGVirtualDisplayMode(width: 2560, height: 1600, refreshRate: 50000),
            CGVirtualDisplayMode(width: 1920, height: 1200, refreshRate: 50000),
            CGVirtualDisplayMode(width: 1680, height: 1050, refreshRate: 50000),
            CGVirtualDisplayMode(width: 1440, height: 900, refreshRate: 50000),
            CGVirtualDisplayMode(width: 1280, height: 800, refreshRate: 50000),
        ]
